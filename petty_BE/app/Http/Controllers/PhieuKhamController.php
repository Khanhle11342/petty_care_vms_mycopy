...
class PhieuKhamController extends Controller
{
     ...
     * Cập nhật phiếu khám
     */
    public function update(UpdatePhieuKhamRequest $request, PhieuKham $phieuKham)
    {
        try {
